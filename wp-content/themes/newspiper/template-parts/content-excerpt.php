...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> <?php newspiper_schema_microdata( 'blogposts' )?>>
	<?php newspiper_post_thumbnail('medium_large'); ?>
	...
	<?php if ( 'post' === get_post_type() ) :
		...
		<p class="entry-content" <?php newspiper_schema_microdata( 'entry-content' ); ?>>
			<?php newspiper_the_excerpt( esc_attr( get_theme_mod( 'newspiper_excerpt_length', 15 ) ) ); 
