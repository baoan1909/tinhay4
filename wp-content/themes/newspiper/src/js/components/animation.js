...
export function postLoopAnimation() {
	if ( document.body.className.indexOf( 'single' ) > -1 || document.body.className.indexOf( 'page ' ) > -1 ) {
		return;
	}
...
// for articles in viewport, run the animation on page load for better ui
