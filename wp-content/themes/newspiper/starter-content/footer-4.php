...
<!-- /wp:group -->
    ',
    esc_html_x( 'Get in Touch', 'Theme starter content', 'newspiper' ),
    esc_url( 'mailto:info@example.com' ),
    esc_html_x( 'info@example.com', 'Theme starter content', 'newspiper' ),
    esc_html_x( 'Opening Hours: 10:00 – 13:00', 'Theme starter content', 'newspiper' )
);

return array(
    'newspiper_text_4' => array(
        'text' ,
        array(
          'title' => null,
