...
function newspiper_sanitize_checkbox( $checked ) {
    // Boolean check.
    return ( ( isset( $checked ) && true == $checked ) ? true : false );
}

// select sanitization function
function newspiper_sanitize_select( $input, $setting ) {
...
function newspiper_sanitize_html( $text ) {
	return wp_kses_post( force_balance_tags( $text ) );;
}

function newspiper_sanitize_image( $image, $setting ) {
    /*
...
function newspiper_sanitize_url( $input ) {
