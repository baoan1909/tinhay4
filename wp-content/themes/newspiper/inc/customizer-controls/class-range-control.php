...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Newspiper_Range_Slider_Control' ) ) {
	/**
	 ...
	 * @since 1.3.47
	 */
	class Newspiper_Range_Slider_Control extends WP_Customize_Control {
		/**
		 * The control type.
		 *
		 * @access public
		 * @var string
		 */
		public $type = 'newspiper-range-slider';
		...
		public function to_json() {
			...
			$this->json['desktop_label'] = esc_html__( 'Desktop', 'newspiper' );
			$this->json['tablet_label']  = esc_html__( 'Tablet', 'newspiper' );
			$this->json['mobile_label']  = esc_html__( 'Mobile', 'newspiper' );
			$this->json['reset_label']   = esc_html__( 'Reset', 'newspiper' );
		...
		public function enqueue() {
			wp_enqueue_script( 'newspiper-custom-controls-js', trailingslashit( get_template_directory_uri() ) . 'inc/customizer-controls/js/custom-controls.js', array( 'jquery', 'customize-base', 'jquery-ui-slider' ), NEWSPIPER_VERSION, true );
			wp_enqueue_style( 'newspiper-custom-controls-css', trailingslashit( get_template_directory_uri() ) . 'inc/customizer-controls/css/custom-controls.css', array(), NEWSPIPER_VERSION );
		}
		...
		protected function content_template() {
			?>
			<div class="newspiper-range-slider-control">
					...
					<div class="gp-range-slider-controls">
						<span class="gp-device-controls">
							<# if ( 'undefined' !== typeof ( data.desktop ) ) { #>
								<span class="newspiper-device-desktop dashicons dashicons-desktop" data-option="desktop" title="{{ data.desktop_label }}"></span>
							<# } #>
						</span>

						<span title="{{ data.reset_label }}" class="newspiper-reset dashicons dashicons-image-rotate"></span>
					</div>
				</div>
