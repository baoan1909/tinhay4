<?php
/**
 * Custom Checkbox Control for the Theme Customizer.
 *
 * @package Newspiper
 */

if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Newspiper_Pill_Checkbox_Custom_Control' ) ) { 
	/**
	 ...
	 */
	class Newspiper_Pill_Checkbox_Custom_Control extends WP_Customize_Control {
		/**
