...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'Newspiper_Sortable_Repeater_Custom_Control' ) ) {
	 ...
	 */
	class Newspiper_Sortable_Repeater_Custom_Control extends WP_Customize_Control {
		/**
