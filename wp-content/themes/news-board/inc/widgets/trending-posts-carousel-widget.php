	...
	class Flash_News_Trending_Posts_Carousel_Widget extends WP_Widget {
		...
		public function __construct() {
			$flash_news_trending_posts_carousel_widget_ops = array(
				...
				'description' => __( 'Retrive Trending Posts Carousel Widgets', 'news-board' ),
			);
			parent::__construct(
				'flash_news_trending_posts_carousel_widget',
				__( 'Ascendoor Trending Posts Carousel Widget', 'news-board' ),
		...
		public function form( $instance ) {
			...
			?>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Section Title:', 'news-board' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_label' ) ); ?>"><?php esc_html_e( 'View All Button:', 'news-board' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_link' ) ); ?>"><?php esc_html_e( 'View All Button URL:', 'news-board' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'offset' ) ); ?>"><?php esc_html_e( 'Number of posts to displace or pass over:', 'news-board' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php esc_html_e( 'Select the category to show posts:', 'news-board' ); ?></label>
